...
{
    public abstract class AssWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AssWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AssWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AssDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AssDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AssDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AssDbContext, Task<T>> func)
        {
            T result;
