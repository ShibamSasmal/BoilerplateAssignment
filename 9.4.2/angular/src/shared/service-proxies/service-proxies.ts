...
export class CountryServiceProxy {
     ...
     * @return OK
     */
    getAllLinksByCountryId(countryId: number | undefined): Observable<LinkDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Country/GetAllLinksByCountryId?";
        if (countryId === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllLinksByCountryId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllLinksByCountryId(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<LinkDto[]>;
                }
            } else
    ...
    protected processGetAllLinksByCountryId(response: HttpResponseBase): Observable<LinkDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
@Injectable()
export class DashboardNoteServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return OK
     */
    create(body: CreateDashboardNoteDetailDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/DashboardNote/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    getNotesByUserId(userId: number | undefined): Observable<DashboardNoteDetail[]> {
        let url_ = this.baseUrl + "/api/services/app/DashboardNote/GetNotesByUserId?";
        if (userId === null)
            throw new Error("The parameter 'userId' cannot be null.");
        else if (userId !== undefined)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetNotesByUserId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetNotesByUserId(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<DashboardNoteDetail[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<DashboardNoteDetail[]>;
        }));
    }

    protected processGetNotesByUserId(response: HttpResponseBase): Observable<DashboardNoteDetail[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(DashboardNoteDetail.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
@Injectable()
export class FaviconServiceServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return OK
     */
    downloadFavicon(url: string | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/FaviconService/DownloadFavicon?";
        if (url === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDownloadFavicon(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDownloadFavicon(response_ as any);
                } catch (e) {
    ...
    protected processDownloadFavicon(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class LinkServiceProxy {
     ...
     * @return OK
     */
    create(body: CreateLinkDto | undefined): Observable<LinkDto> {
        let url_ = this.baseUrl + "/api/services/app/Link/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<LinkDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<LinkDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Link/GetAll?";
        if (sorting === null)
            throw new Error("The parameter 'sorting' cannot be null.");
        else if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<LinkDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<LinkDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<LinkDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = LinkDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    get(id: number | undefined): Observable<LinkDto> {
        let url_ = this.baseUrl + "/api/services/app/Link/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<LinkDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    update(body: LinkDto | undefined): Observable<LinkDto> {
        let url_ = this.baseUrl + "/api/services/app/Link/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<LinkDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Link/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
@Injectable()
export class LinkCountryMappingServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return OK
     */
    get(id: number | undefined): Observable<LinkCountryMappingDto> {
        let url_ = this.baseUrl + "/api/services/app/LinkCountryMapping/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<LinkCountryMappingDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<LinkCountryMappingDto>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<LinkCountryMappingDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = LinkCountryMappingDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<LinkCountryMappingDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/LinkCountryMapping/GetAll?";
        if (sorting === null)
            throw new Error("The parameter 'sorting' cannot be null.");
        else if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<LinkCountryMappingDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<LinkCountryMappingDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<LinkCountryMappingDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = LinkCountryMappingDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    create(body: CreateLinkCountryMappingDto | undefined): Observable<LinkCountryMappingDto> {
        let url_ = this.baseUrl + "/api/services/app/LinkCountryMapping/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<LinkCountryMappingDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    update(body: LinkCountryMappingDto | undefined): Observable<LinkCountryMappingDto> {
        let url_ = this.baseUrl + "/api/services/app/LinkCountryMapping/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<LinkCountryMappingDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/LinkCountryMapping/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class LocationServiceProxy {
    ...
    getAllCountries(): Observable<CountriesDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Location/GetAllCountries";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllCountries(response: HttpResponseBase): Observable<CountriesDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    getStatesByCountry(countryId: number | undefined): Observable<StateDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Location/GetStatesByCountry?";
        if (countryId === null)
            throw new Error("The parameter 'countryId' cannot be null.");
        else if (countryId !== undefined)
            url_ += "countryId=" + encodeURIComponent("" + countryId) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetStatesByCountry(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetStatesByCountry(response_ as any);
                } catch (e) {
    ...
    protected processGetStatesByCountry(response: HttpResponseBase): Observable<StateDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    getCitiesByState(stateId: number | undefined): Observable<CityDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Location/GetCitiesByState?";
        if (stateId === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCitiesByState(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCitiesByState(response_ as any);
                } catch (e) {
    ...
    protected processGetCitiesByState(response: HttpResponseBase): Observable<CityDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
@Injectable()
export class UserAndLinkMappingServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return OK
     */
    getMappingsForUserAndCategory(userId: number | undefined, categoryId: number | undefined): Observable<UserAndLinkMappingDto[]> {
        let url_ = this.baseUrl + "/api/services/app/UserAndLinkMapping/GetMappingsForUserAndCategory?";
        if (userId === null)
            throw new Error("The parameter 'userId' cannot be null.");
        else if (userId !== undefined)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetMappingsForUserAndCategory(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMappingsForUserAndCategory(response_ as any);
                } catch (e) {
    ...
    protected processGetMappingsForUserAndCategory(response: HttpResponseBase): Observable<UserAndLinkMappingDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    saveMappings(body: CreateUserAndLinkMappingDto[] | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/UserAndLinkMapping/SaveMappings";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSaveMappings(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSaveMappings(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processSaveMappings(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    updateLinkOrder(body: UserAndLinkMappingDto[] | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/UserAndLinkMapping/UpdateLinkOrder";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateLinkOrder(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateLinkOrder(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processUpdateLinkOrder(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    get(id: number | undefined): Observable<UserAndLinkMappingDto> {
        let url_ = this.baseUrl + "/api/services/app/UserAndLinkMapping/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<UserAndLinkMappingDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = UserAndLinkMappingDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<UserAndLinkMappingDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/UserAndLinkMapping/GetAll?";
        if (sorting === null)
            throw new Error("The parameter 'sorting' cannot be null.");
        else if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<UserAndLinkMappingDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<UserAndLinkMappingDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<UserAndLinkMappingDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = UserAndLinkMappingDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    create(body: CreateUserAndLinkMappingDto | undefined): Observable<UserAndLinkMappingDto> {
        let url_ = this.baseUrl + "/api/services/app/UserAndLinkMapping/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<UserAndLinkMappingDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    update(body: UserAndLinkMappingDto | undefined): Observable<UserAndLinkMappingDto> {
        let url_ = this.baseUrl + "/api/services/app/UserAndLinkMapping/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<UserAndLinkMappingDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/UserAndLinkMapping/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class CreateDashboardNoteDetailDto implements ICreateDashboardNoteDetailDto {
    userId: number;
    htmlContent: string | undefined;

    constructor(data?: ICreateDashboardNoteDetailDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateDashboardNoteDetailDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateDashboardNoteDetailDto();
        result.init(data);
        return result;
    }
    ...
    clone(): CreateDashboardNoteDetailDto {
        const json = this.toJSON();
        let result = new CreateDashboardNoteDetailDto();
        result.init(json);
        return result;
...
export interface ICreateDashboardNoteDetailDto {
    userId: number;
    htmlContent: string | undefined;
}

export class CreateLinkCountryMappingDto implements ICreateLinkCountryMappingDto {
    linkId: number;
    countryId: number;

    constructor(data?: ICreateLinkCountryMappingDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateLinkCountryMappingDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateLinkCountryMappingDto();
        result.init(data);
        return result;
    }
    ...
    clone(): CreateLinkCountryMappingDto {
        const json = this.toJSON();
        let result = new CreateLinkCountryMappingDto();
        result.init(json);
        return result;
...
export interface ICreateLinkCountryMappingDto {
    linkId: number;
    countryId: number;
}
...
export class CreateLinkDto implements ICreateLinkDto {
    ...
    constructor(data?: ICreateLinkDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateLinkDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateLinkDto();
        result.init(data);
        return result;
    }
...
export class CreateUserAndLinkMappingDto implements ICreateUserAndLinkMappingDto {
    categoryId: number;
    userId: number;
    linkId: number;
    isActive: boolean;

    constructor(data?: ICreateUserAndLinkMappingDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateUserAndLinkMappingDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateUserAndLinkMappingDto();
        result.init(data);
        return result;
    }
    ...
    clone(): CreateUserAndLinkMappingDto {
        const json = this.toJSON();
        let result = new CreateUserAndLinkMappingDto();
        result.init(json);
        return result;
...
export interface ICreateUserAndLinkMappingDto {
    categoryId: number;
    userId: number;
    linkId: number;
    isActive: boolean;
...
export class DashboardNoteDetail implements IDashboardNoteDetail {
    id: number;
    ...
    constructor(data?: IDashboardNoteDetail) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): DashboardNoteDetail {
        data = typeof data === 'object' ? data : {};
        let result = new DashboardNoteDetail();
        result.init(data);
        return result;
    }
...
export interface IDashboardNoteDetail {
    id: number;
    creationTime: moment.Moment;
    creatorUserId: number | undefined;
    lastModificationTime: moment.Moment | undefined;
...
export class LinkCountryMappingDto implements ILinkCountryMappingDto {
    id: number;
    linkId: number;
    countryId: number;

    constructor(data?: ILinkCountryMappingDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LinkCountryMappingDto {
        data = typeof data === 'object' ? data : {};
        let result = new LinkCountryMappingDto();
        result.init(data);
        return result;
    }
...
export interface ILinkCountryMappingDto {
    id: number;
    linkId: number;
    countryId: number;
}

export class LinkCountryMappingDtoPagedResultDto implements ILinkCountryMappingDtoPagedResultDto {
    items: LinkCountryMappingDto[] | undefined;
    totalCount: number;

    constructor(data?: ILinkCountryMappingDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(LinkCountryMappingDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): LinkCountryMappingDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new LinkCountryMappingDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): LinkCountryMappingDtoPagedResultDto {
        const json = this.toJSON();
        let result = new LinkCountryMappingDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface ILinkCountryMappingDtoPagedResultDto {
    items: LinkCountryMappingDto[] | undefined;
    totalCount: number;
}
...
export class LinkDto implements ILinkDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["countryNames"])) {
                this.countryNames = [] as any;
                for (let item of _data["countryNames"])
                    this.countryNames.push(item);
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.countryNames)) {
            data["countryNames"] = [];
            for (let item of this.countryNames)
                data["countryNames"].push(item);
        }
        return data;
    }
...
export class LinkDtoPagedResultDto implements ILinkDtoPagedResultDto {
    items: LinkDto[] | undefined;
    totalCount: number;

    constructor(data?: ILinkDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LinkDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new LinkDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface ILinkDtoPagedResultDto {
    items: LinkDto[] | undefined;
    totalCount: number;
}
...
export class UserAndLinkMappingDto implements IUserAndLinkMappingDto {
    id: number;
    categoryId: number;
    userId: number;
    linkId: number;
    ...
    static fromJS(data: any): UserAndLinkMappingDto {
        data = typeof data === 'object' ? data : {};
        let result = new UserAndLinkMappingDto();
        result.init(data);
        return result;
    }
...
export interface IUserAndLinkMappingDto {
    id: number;
    categoryId: number;
    userId: number;
    linkId: number;
...
export class UserAndLinkMappingDtoPagedResultDto implements IUserAndLinkMappingDtoPagedResultDto {
    items: UserAndLinkMappingDto[] | undefined;
    totalCount: number;

    constructor(data?: IUserAndLinkMappingDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(UserAndLinkMappingDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): UserAndLinkMappingDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new UserAndLinkMappingDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): UserAndLinkMappingDtoPagedResultDto {
        const json = this.toJSON();
        let result = new UserAndLinkMappingDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IUserAndLinkMappingDtoPagedResultDto {
    items: UserAndLinkMappingDto[] | undefined;
    totalCount: number;
}
...
export class UserDto implements IUserDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.countryId = _data["countryId"];
            this.countryNames = _data["countryNames"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["countryId"] = this.countryId;
        data["countryNames"] = this.countryNames;
        return data;
    }
